...
// Docusaurus sets this to 'production' for 'npm run build'
// and 'development' for 'npm run start'
...
const config: Config = {
    ...
    url: isProd ? 'https://kotoMJ.github.io' : 'http://localhost:3000',


    // Set the /<baseUrl>/ pathname under which your site is served
    // For GitHub pages deployment, it is often '/<projectName>/'
    //baseUrl: "/",
    baseUrl: isProd ? '/android-sdk-crypto-ecosystem-doc/' : '/',
        ...
        [
            "classic",
            {
                ...
                blog: {
                    ...
                    // Remove this to remove the "edit this page" links.
                    editUrl:
                        'https://github.com/kotoMJ/android-sdk-crypto-ecosystem-doc/tree/main/',
                },
                theme: {
