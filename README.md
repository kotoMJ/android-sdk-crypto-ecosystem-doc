...
To change sidebar item title or order, look for existing **_tags_**  `sidebar_*` on the top of the  `*.md ` pages.  
...
Copy dokka API reference outputs to the `static/android-reference/YYYY.MM.AB` folder.
